...
import { init as SentryInit, sentryHandle as SentryHandle, handleErrorWithSentry as SentryHandleError } from '@sentry/sveltekit';
...
export const handleError: HandleServerError = SentryHandleError(async (input) => {
	if (dev) {
